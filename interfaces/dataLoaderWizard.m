...
%% Import SEM images
    function [imgs1,dxy] = importImages(f1, dataPath, varargin)
        ...
        if endsWith(f1,".h5oina")
            ...
            %exclude FSD images (5 channels each) and 'Header' struct
            excludeList = contains(h5ImgsNames,'Lower_Centre_','IgnoreCase',true) | ...
                             contains(h5ImgsNames,'Lower_Left_','IgnoreCase',true) | ...
                             contains(h5ImgsNames,'Lower_Right_','IgnoreCase',true) | ...
                             contains(h5ImgsNames,'Upper_Left_','IgnoreCase',true) | ...
                             contains(h5ImgsNames,'Upper_Right_','IgnoreCase',true) | ...
                             h5ImgsNames=="Header";
            semNames = h5ImgsNames(~excludeList);
