...
static emlrtRSInfo x_emlrtRSI = {
    60,     /* lineNo */
    "fft2", /* fcnName */
    "/usr/local/MATLAB/R2025a/toolbox/eml/lib/matlab/datafun/fft2.m" /* pathName
                                                                      */
};
...
static emlrtRTEInfo ib_emlrtRTEI = {
    ...
    1,      /* colNo */
    "fft2", /* fName */
    "/usr/local/MATLAB/R2025a/toolbox/eml/lib/matlab/datafun/fft2.m" /* pName */
};
...
static emlrtRTEInfo jb_emlrtRTEI = {
    ...
    "/usr/local/MATLAB/R2025a/toolbox/eml/eml/+coder/+internal/+fft/"
    "MATLABFFTWCallback.m" /* pName */
};

/* Function Definitions */
void fft2(const emlrtStack *sp, const emxArray_real_T *x, emxArray_creal_T *y)
{
  emlrtStack b_st;
  emlrtStack c_st;
  emlrtStack d_st;
  ...
  if ((x->size[0] == 0) || (x->size[1] == 0)) {
    ...
    if (b_x) {
      ...
      acc->size[0] = x->size[0];
      acc->size[1] = x->size[1];
      emxEnsureCapacity_creal_T(&e_st, acc, loop_ub, &jb_emlrtRTEI);
      acc_data = acc->data;
      emlrtFFTW_1D_R2C((real_T *)&x_data[0], (real_T *)&acc_data[0], 1,
      ...
      emlrtFFTW_1D_C2C((real_T *)&acc_data[0], (real_T *)&y_data[0],
                       acc->size[0], x->size[1], acc->size[1], acc->size[0],
                       -1);
    }
  }
  if (guard1) {
    ...
    y->size[0] = x->size[0];
    y->size[1] = x->size[1];
    emxEnsureCapacity_creal_T(&st, y, loop_ub, &ib_emlrtRTEI);
    y_data = y->data;
